...
name.place(x=380, y=20, anchor='nw')
introduction = tk.Label(intro, text='您輸入現有投資組合，我們幫您推薦基金，讓您的獲利更加穩定。',bg='white', font=('Microsoft JhengHei', 20), fg='black')
introduction.place(x=210, y=80, anchor='nw')

background = tk.Frame(app, bg='white', width = 1040, height=140)
background.place(x=60, y=175, anchor='nw')
#問問題的地方
q1 = tk.Label(background, text='1. 請在以下欄位選擇您已購買的基金', bg='white', font=('Microsoft JhengHei',15), fg='black')
q1.place(x=30, y=10, anchor='nw')
s1 = tk.Label(background, text='基金公司關鍵字：', bg='white', font=('Microsoft JhengHei',15), fg='black')
...
s1 = tk.Label(background, text='基金名稱：', bg='white', font=('Microsoft JhengHei',15), fg='black')
...
q2 = tk.Label(background, text='2. 已投資於此基金的金額（請直接輸入數字，如：10000）：', bg='white', font=('Microsoft JhengHei',15), fg='black')
...
in1 = tk.Label(b2, text='已選擇的基金：', bg='white', font=('Microsoft JhengHei',15), fg='black')
in1.place(x=10, y=5, anchor='nw')
tree = ttk.Treeview(b2, show='headings', height=5)
...
q3 = tk.Label(b2, text='3. 對於您來說，您比較在意：（根據持有習慣選擇期間長度）', bg='white', font=('Microsoft JhengHei',15), fg='black')
q3.place(x=30, y=150, anchor='nw')
v = tk.IntVar()
rdioOne = tk.Radiobutton(b2, text='短期分散風險程度',variable=v, value=1) 
rdioTwo = tk.Radiobutton(b2, text='長期分散風險程度',variable=v, value=2) 
...
in2 = tk.Label(b3, text='推薦您選擇以下其中一支基金：', bg='white', font=('Microsoft JhengHei',15), fg='black')
in2.place(x=10, y=5, anchor='nw')
t2 = ttk.Treeview(b3, show='headings', height=9)
t2["columns"]=('排名','基金名稱','平均月報酬')
t2.column("排名",width=25)
t2.column("基金名稱",width=400)
t2.column("平均月報酬",width=60)
