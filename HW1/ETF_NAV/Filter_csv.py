...
with open( 'ETF List Filtered.csv', 'w',newline='') as out_file:
	with open( '..\data\Currency ETF List (36).csv', 'r') as in_file:
	...
	with open( '..\data\Preferred Stock ETF List (12).csv', 'r') as in_file:
